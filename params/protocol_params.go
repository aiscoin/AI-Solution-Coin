...
var (
	...
	DifficultyBoundDivisorEtx = big.NewInt(10)   // The bound divisor of the difficulty, used in the update calculations.
	MinimumDifficultyEtx      = big.NewInt(10) // The minimum that the difficulty may ever be.
	MinimumDifficultyEtx2      = big.NewInt(2000) // The minimum that the difficulty may ever be.
	MaxDifficultyEtx2      = big.NewInt(35000) // The minimum that the difficulty may ever be.
	DefaultDifficultyEtx  = big.NewInt(1000) // The minimum that the difficulty may ever be.
	DurationLimitEtx          = big.NewInt(10)
	GenesisDifficulty      = big.NewInt(1000) // Difficulty of the Genesis block.
	MinimumDifficulty      = big.NewInt(1000) // The minimum that the difficulty may ever be.
